...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a class="nav-link custom-nav-link" href="studentviewfeedback.php">Current Mess Feedback</a>
                         <a class="nav-link custom-nav-link" href="chan_mess.html">Change Mess</a>
                        <a class="nav-link custom-nav-link" href="payment.php">Check Dues</a>
    ...
    <div id="sectionexpense">
        ...
        <div class="tip-calculator-container pb-5" style="background-image: url();">
            <h1 class="tip-calculator-heading text-center mt-4 mb-4">Extras Calculator</h1>

            <form action="extras.php" method="post">

            <label for="extra">Extras Taken</label>
            <input class="un " type="text" name="amt" align="amount" placeholder="Extras">
            
            
                  

                   <div class="col-12 text-center mt-4">
                        <button class="btn btn-info calculate-tip-button mr-3" name="submit" id="calculateButton" onclick="calculate()">Add</button>
                        <button class="btn btn-info calculate-tip-button" name="delete" id="calculateButton" onclick="refresh()">Refresh</button>
