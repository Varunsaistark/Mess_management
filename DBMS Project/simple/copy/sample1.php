...
$result = mysqli_query($mysqli, 'SELECT SUM(Rating) AS value_sum FROM feedback');
...
$sum1 = $row1['count'];
if($sum1==0){
  $stmt = $mysqli->prepare("insert into mess_day_rating(Mess_ID,DayType,Date,Avg_Rating)values(?,?,?,?)");
